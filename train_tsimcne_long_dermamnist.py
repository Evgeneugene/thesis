...
fig.savefig("tsimcne_dermamnist_long_auccl.png")
...
npz_images = np.savez('numpy_files/tsimcne_dermamnist_long__auccl_all.npz', embeddings=Y, labels=labels, images=images)