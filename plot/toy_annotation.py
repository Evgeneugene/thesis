...
def annotate_aml(ax):
    npz_path = f'{root}/tsimcne_leukemia_long_all.npz'
    label_color_dict = {
        0: ('#2ca02c', 'BAS'),
        1: ("#008080", 'EBpythonO'),
        2: ("#808000", 'EOS'),
...
def annotate_bld(ax):
    classes={
            ...
            4: 'LYMPH',
            0: 'BAS'}
    npz_path=f'{root}/tsimcne_bloodmnist_long_all.npz'
...
def annotate_derma(ax):
    classes={0: 'OTHERS',
             1: 'M.NEVI'}
    npz_path=f'{root}/tsimcne_dermamnist_long_all.npz'
...
def main():
    ...
    plt.savefig('../figures/toy_datasets_long.png', dpi=1000)
    plt.savefig('../figures/toy_datasets_long.pdf', dpi=1000)
